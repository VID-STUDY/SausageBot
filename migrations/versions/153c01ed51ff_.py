...
Revision ID: 153c01ed51ff
Revises: ae27c71f1de3
Create Date: 2020-09-30 02:47:43.551368
...
revision = '153c01ed51ff'
down_revision = 'ae27c71f1de3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('about_text', sa.String(length=150), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
